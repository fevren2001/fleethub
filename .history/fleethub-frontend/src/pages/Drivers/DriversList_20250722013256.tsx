      ...
      <div className="drivers-list">
        <div className="page-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
            <div style={{ display: 'flex', background: '#f3f4f6', borderRadius: 24, padding: 4, boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
              <button
                style={view === 'list' ? { background: '#3498db', color: '#fff', fontWeight: 'bold', border: 'none', borderRadius: 20, padding: '8px 18px', cursor: 'pointer', margin: 2 } : { background: 'transparent', color: '#888', border: 'none', borderRadius: 20, padding: '8px 18px', cursor: 'pointer', margin: 2 }}
              ...
              <button
                style={view === 'card' ? { background: '#3498db', color: '#fff', fontWeight: 'bold', border: 'none', borderRadius: 20, padding: '8px 18px', cursor: 'pointer', margin: 2 } : { background: 'transparent', color: '#888', border: 'none', borderRadius: 20, padding: '8px 18px', cursor: 'pointer', margin: 2 }}
            ...
            <Link to="/drivers/new" style={{ background: '#22c55e', color: '#fff', fontWeight: 600, border: 'none', borderRadius: 8, padding: '10px 24px', textDecoration: 'none', fontSize: 16, boxShadow: '0 1px 4px rgba(34,197,94,0.08)' }}>Add Driver</Link>
          </div>
        </div>
