        ...
        <div style={{ display: 'flex', gap: 16, marginBottom: 24 }}>
          <button
            style={activeTab === 'pending'
              ? { background: '#3498db', color: '#fff', fontWeight: 'bold', padding: '10px 24px', borderRadius: '8px 8px 0 0', border: 'none', marginRight: 8, cursor: 'pointer' }
              : { background: '#e5e7eb', color: '#888', padding: '10px 24px', borderRadius: '8px 8px 0 0', border: 'none', marginRight: 8, cursor: 'pointer' }}
            onClick={() => setActiveTab('pending')}
          >
            Available
          </button>
          <button
            style={activeTab === 'in_progress'
              ? { background: '#3498db', color: '#fff', fontWeight: 'bold', padding: '10px 24px', borderRadius: '8px 8px 0 0', border: 'none', marginRight: 8, cursor: 'pointer' }
              : { background: '#e5e7eb', color: '#888', padding: '10px 24px', borderRadius: '8px 8px 0 0', border: 'none', marginRight: 8, cursor: 'pointer' }}
